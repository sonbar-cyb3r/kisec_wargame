	...
	if (isset($PaymentAction)) {
		if ($PaymentAction == "Y") {
			...
			if ($GoodsCode == "3012383") {
				...
				if (($OriginalCost - $CostDC) == $TotalCost) {
	  ...
	  <div class="modal-dialog">
		<div  class="modal-content">
		  ...
		  <form name="Payment" action="PaymentStep2.php" method="POST">		 
			...
			<div class="form-group">
			<label>결제 금액</label>
			<input id="pay" name="amount" class="form-control" type="text" placeholder="<?=number_format($TotalCost)?>원" readonly>
			...
			<?} else if ($PaymentCheck == "Y") {?>
				...
				<p></p>
				<div class="well well-sm">인증키 : <?=AuthenticationKeyCreate("1","2", $userid)?></div>
				</div>
			<?}?>			
		  </div>
		  </form>
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="334145120055b893884e6bab-|49" defer=""></script>
  </body>
</html>
